#Dasafio 1 Strings Parte 1 Basico desenvolvido por Andrey Contadini Veiga
...
for linha in linhas:
    justifica=linha.rjust(40) #A função rjust justifica a linha em 40 caracteres, preenchendo com espaço em braco os caracters restantes
    print(justifica)